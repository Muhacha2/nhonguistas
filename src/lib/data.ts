...
const comments: Record<string, Comment[]> = {
  g1: [
    { id: 'c1', author: users[1], content: 'Wow, amazing shot!', createdAt: '1h ago' },
    { id: 'c2', author: users[2], content: 'I wish I was there!', createdAt: '30m ago' },
  ],
  g2: [
    { id: 'c3', author: users[0], content: 'Congrats on the launch!', createdAt: '4h ago' },
  ],
  g3: [
    { id: 'c4', author: users[3], content: 'Looks so peaceful.', createdAt: '1d ago' },
    { id: 'c5', author: users[0], content: 'What trail is this?', createdAt: '20h ago' },
    { id: 'c6', author: users[2], content: 'It\'s the "Eagle Peak" trail. Highly recommend!', createdAt: '19h ago' },
  ],
  g4: [],
  g5: [
    { id: 'c7', author: users[0], content: 'I need to check this out.', createdAt: '2d ago' },
  ],
};
